...
#Remote data file
revenue_file_version <- "H:/workspace2016/Revenue/Data/IMRevenueTest.xlsx";
Macro_file <- "../Library/Data/Masterfile-Data Process-11-17-16.xlsx";#Newest Version
###Local Files
variable_file_version <- "./Data/VariableSelection-Revenue-IMTest.xlsx";

Output_root <- "../Revenue-Results/Output-Q22016-IMwithoutFlow/";
Time_periods <- 1:114;
Time_periods_Q <- 1:38;
