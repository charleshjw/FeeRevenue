...
###Local Files
variable_file_version <- "./Data/VariableSelection-Revenue-TSTest.xlsx";
#variable_file_maq_version <- "./Data/VariableSelection-MAQ.xlsx";

TEST_ENVIRONMENT <- FALSE;
EXECUTE_DATA_EXAM <- FALSE;
EXECUTE_COMPONENT_ANALYSIS_MAQ <- FALSE;
EXECUTE_COMPONENT_ANALYSIS_LOB <- FALSE;
EXECUTE_SEGMENTATION_ANALYSIS_MAQ_ACCOUNT <- FALSE;
...
#Output_root <- "./Output-Q22016-CTTest/";
...
##		bu<-1
#		BU <- BUS[bu];
#		file_name <- paste0("./BUTest/Revenue-ComponentAnalysis-",BU,".R");
