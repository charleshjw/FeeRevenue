...
#	revenue_lob_raw[1,];
#	revenue_lob_raw[,1];
segment1 <- c("DomesticClearance","InternationalClearance","GlobalClearance","CDInterchangeService","DomesticCollateral","GlobalTriParty","PremiumService","DaylightOverdraft","GlobalLiquidityService","BrokerDayLoan","NonCoreFees","RateIncreaseMinus","CommittedCreditFacility","RateIncreasePlus");
...
segment1 <- c("Clearance","DomesticCollateral","GlobalTriParty","Other","DaylightOverdraft","CommittedCreditFacility","RateIncreasePlus");
segment1 <- paste0("Revenue.",segment1)
...
segment1 <- c("DomesticClearance","InternationalClearance","GlobalClearance","CDInterchangeService","DomesticCollateral","GlobalTriParty","PremiumService","GlobalLiquidityService","BrokerDayLoan","NonCoreFees","RateIncreaseMinus","DaylightOverdraft","CommittedCreditFacility","RateIncreasePlus");
segment1 <- paste0("Revenue.",segment1);
...
#
#segment1 <- c("DomesticCollateral","GlobalCollateral","Clearance","DaylightOD","CDInterchange","CDEquity","GlobalClearing","GlobalLiquidityService","InternationalClearing","BrokerDayLoan","PremiumService","CommittedCreditFacility");
#segment1 <- paste0("Revenue.",segment1);
