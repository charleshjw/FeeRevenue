...
#		segment <- 1;
	...
	#	revenue_lob_raw[,1]
		...
		Output_file_regression <- paste(Output_file,"/Analysis-DiffRegression-Segment-",segment,sep="");
			...
			if(determine_frequency_and_start(revenues[[j]][,1])$frequency==12) {
				...
				if (revenue_analysis(revenue,revenue_threshold)) {
					...
					tryCatch(
							{
								if (EXECUTE_ALGO_1) {
									Variable_Selection_Diff_1variable(threshold,Output_file_regression_item1,revenue,Macro);
									Variable_Selection_Diff_2variable(threshold,Output_file_regression_item2,revenue,.Macro);
								}
								
								if (EXECUTE_ALGO_2) {
									Variable_Selection_Diff_1variable_Test1(num_models_to_examine,Output_file_regression_item1,revenue,Macro,Macro_2,Macro_3,Macro_4,BU);
									Variable_Selection_Diff_2variable_Test1(num_models_to_examine,Output_file_regression_item2,revenue,Macro,Macro_2,Macro_3,Macro_4,BU);			
								}
							}, error = function(e) {
								print(e);
								print(BU);
				...
				if (revenue_analysis(revenue,revenue_threshold)) {
					...
					tryCatch(
							{				
								if (EXECUTE_ALGO_1) {	
									Variable_Selection_Diff_1variable(threshold,Output_file_regression_item1,revenue,Macro_Q);
									Variable_Selection_Diff_2variable(threshold,Output_file_regression_item2,revenue,.Macro);
								}
								
								if (EXECUTE_ALGO_2) {
									Variable_Selection_Diff_1variable_Test1(num_models_to_examine,Output_file_regression_item1,revenue,Macro_Q,Macro_2_Q,Macro_3_Q,Macro_4_Q,BU);
									Variable_Selection_Diff_2variable_Test1(num_models_to_examine,Output_file_regression_item2,revenue,Macro_Q,Macro_2_Q,Macro_3_Q,Macro_4_Q,BU);			
								}
							}, error = function(e) {
								print(e);
								print(BU);
