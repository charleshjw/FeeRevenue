...
segment1 <- c("IssuranceFees","CancellationFees","DividendFees","ServicingFee","MiscFee","LicensingFee","TaxReclaimFee","Other","Amortization");
...
segment1 <- c("IssuranceFees","CancellationFees","DividendFees","ServicingFee","AllOtherRev","Amortization");
segment1 <- paste0("Revenue.",segment1)
length(segment1) == sum(colnames(revenue_lob)%in%segment1);
...
segment1 <- c("IssuranceFees","CancellationFees","SponsoredProgram","Amortization");
segment1 <- paste0("Revenue.",segment1)
length(segment1) == sum(colnames(revenue_lob)%in%segment1);
...
#.frequency <- start_and_frequency$frequency;
#
#segment1 <- c("ProductManagement","GlobalSales","ADRCenter","MarketSolutions","Others");
#segment1 <- paste0("Revenue.",segment1)
#length(segment1) == sum(colnames(revenue_lob)%in%segment1);
