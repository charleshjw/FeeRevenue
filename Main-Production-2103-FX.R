...
###############################
BUS <- c("FX");
revenue_file_version <- "H:/workspace2016/Revenue/Data/RevenuebyLOBv2103.xlsx";
#Macro_file <- "../Library/Data/Masterfile-Data-2103.xlsx";
Macro_file <- "../Library/Data/Masterfile-Data Process-11-17-16.xlsx";#Newest Version
variable_file_version <- "./Data/VariableSelection-Revenue-2103.xlsx";
Output_root <- "./Output-Q22016-CCAR2103/";
